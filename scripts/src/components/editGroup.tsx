    ...
    <div className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 overflow-auto">
      <div className="w-full max-w-md bg-[#0F0F14] border border-white/10 rounded-2xl p-6 flex flex-col gap-4 max-h-[90vh] overflow-y-auto">
        ...
        <input
          ...
          className="w-full rounded-full px-4 py-3 border border-[#EAF0FF1A] bg-transparent text-white outline-none text-[16px] lg:text-sm"
        />
        ...
        <textarea
          ...
          rows={3}
          maxLength={200}
          className="w-full rounded-2xl px-4 py-3 border border-[#EAF0FF1A] bg-transparent text-white outline-none resize-none text-[16px] lg:text-sm"
        />
