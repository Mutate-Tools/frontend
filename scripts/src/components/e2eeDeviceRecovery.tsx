      ...
      <div className="mx-auto mb-4 w-full max-w-[690px] rounded-[20px] border border-white/15 bg-black/35 p-4 text-white backdrop-blur-md">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <input
            ...
            className="min-h-[42px] flex-1 rounded-full border border-white/10 bg-white/10 px-4 text-[16px] lg:text-sm outline-none placeholder:text-white/40"
          />
          <button
        ...
        <div className="mt-3 grid gap-2 sm:grid-cols-[1fr_auto]">
          <input
            ...
            className="min-h-[42px] rounded-full border border-white/10 bg-white/10 px-4 text-[16px] lg:text-sm outline-none placeholder:text-white/40"
          />
  ...
  return (
    <div className="mx-auto mb-4 flex w-full max-w-[690px] flex-col gap-2 rounded-[20px] border border-white/10 bg-white/[0.04] p-3 text-white sm:flex-row sm:items-center">
      ...
      <input
        ...
        className="min-h-[36px] flex-1 rounded-full border border-white/10 bg-white/10 px-3 text-[16px] lg:text-xs outline-none placeholder:text-white/35"
      />
      <button
      ...
      <div className="flex gap-2">
        <input
          ...
          className="min-h-[36px] w-[120px] rounded-full border border-white/10 bg-white/10 px-3 text-[16px] lg:text-xs outline-none placeholder:text-white/35"
        />
        <button
