...
export function DeviceProvider({ children }: { children: ReactNode }) {
  ...
  const restoreVault = useCallback(
    async (passphrase: string) => {
      ...
      try {
        ...
        await uploadPrekeysForStoredIdentities();
    ...
    [token, parentEmailHash, uploadPrekeysForStoredIdentities, notifyKeysReady]
  );
  ...
  const pollDeviceLink = useCallback(
    ...
    [token, deviceKeypair, uploadPrekeysForStoredIdentities, notifyKeysReady]
  );
  ...
  }, [isConnected, token, deviceId, deviceKeypair, listDevices]);
